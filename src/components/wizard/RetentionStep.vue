...
<template>
  <div class="p-8">
        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <div class="flex items-center gap-2">
              ...
              <span v-if="schedule.is_default" class="text-xs text-blue-600">
                (Default)
              </span>
            </div>
    ...
    <div class="bg-gray-50 rounded-lg p-4">
      ...
      <div class="flex items-center gap-4">
        <input
          ...
          class="flex-1"
        />
        <span class="text-lg font-medium text-gray-900 w-16 text-right">
    ...
    <div
      ...
      class="mt-4 p-4 bg-yellow-50 rounded-lg flex items-start gap-3"
    >
